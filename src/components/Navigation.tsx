          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link href={`/${locale}`} className="flex items-center gap-3 group">
              ...
              <span 
                ...
                style={{ color: onDark ? '#ffffff' : '#1d1d1f' }}
              >
            ...
            <div className="hidden lg:flex items-center gap-6">
              <nav className="flex items-center gap-6" aria-label="Main navigation">
                {navLinks.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className={`nav-link ${isActive(link.href) ? 'nav-link-active' : ''}${overDark ? ' nav-link-on-dark' : ''}`}
              ...
              <button
                onClick={toggleTheme}
                className={`theme-toggle${overDark ? ' theme-toggle-on-dark' : ''}`}
            ...
            <div className="lg:hidden flex items-center gap-2">
              ...
              <button
                ...
                className={`p-2 transition-colors ${
                  onDark ? 'text-neutral-300 hover:text-white' : 'text-gray-500 hover:text-gray-900'
                }`}
              >
                <Globe size={20} />
              </button>
