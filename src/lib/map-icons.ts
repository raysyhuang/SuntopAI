...
// Direct center icon (hospital cross, bright teal with white border)
export const directCenterIcon = new L.DivIcon({
  html: `
    <div class="relative flex items-center justify-center w-10 h-10">
      <div class="absolute inset-0 rounded-full bg-teal-500 border-3 border-white shadow-xl"></div>
...
export const partnerCenterIcon = new L.DivIcon({
  html: `
    <div class="relative flex items-center justify-center w-9 h-9">
      <div class="absolute inset-0 rounded-full bg-purple-500 border-3 border-white shadow-xl"></div>
...
export const createClusterIcon = (cluster: any) => {
  ...
  return new L.DivIcon({
    html: `
      <div class="marker-cluster marker-cluster-${size} ${sizeMap[size]} flex items-center justify-center rounded-full bg-teal-600 border-3 border-white text-white font-bold shadow-xl">
        ${count}
      </div>
    `,
